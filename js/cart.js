...
function atualizarCarrinho() {
  ...
  carrinho.forEach((produto, index) => {
    carrinhoHTML.innerHTML += `<div id='produto${index}' class='d-flex flex-row nav-justify-content-between align-items-center pt-lg-12 pt-md-12 pt-2 pb-3 border-bottom mobile'>
      ...
      <div class= 'd-flex flex-row align-items-center'>
        ...
        <div class='d-flex flex-column pl-md-4 pl-1'>
         ...
         <div class='pl-md-2 pl-1'><b> R$ ${produto.total}</b></div>
